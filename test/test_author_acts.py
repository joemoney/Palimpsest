...
assert m == {"title": "Deliver the letter", "description": "Get it to Harrowgate.", "max_acts": None, "acts": [
    {"orig": 0, "title": "The Quay", "description": "Leave port.", "completion_signals": ["the ferry has sailed"]},
    {"orig": 1, "title": "The Tide Road", "description": "Cross before it closes.", "completion_signals": []}]}, m
