...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": ["a sword that was never picked up"], "social": [],
     "new_characters": []},
])
...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": [], "social": social("Mrs. Abbott", "confided_in_them"),
     "new_characters": []},
])
...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": [], "social": social("Newcomer", "confided_in_them"),
     "new_characters": []},
])
...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": [], "social": social("Marlowe", "kindness_shown"),
...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": [], "social": social("the advocate", "kindness_shown"),
     "new_characters": []},
])
...
se.call_llm_json = CannedResponses([
    {"subplot_progress": {}, "flags_set": {}, "memory_fragments_revealed": [],
     "items_gained": [], "items_lost": [], "social": social("Sable", "kindness_shown"),
     "new_characters": []},
])
